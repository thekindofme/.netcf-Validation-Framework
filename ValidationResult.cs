...
namespace ValidationFramework
{
    ...
    public class ValidationError
    {
		...
		public ValidationError(Rule rule, string errorMessage, InfoDescriptor infoDescriptor, object attemptedValue)
        {
        ...
        /// <summary>
        /// Gets the <see cref="InfoDescriptor"/> that this <see cref="ValidationResult"/> was generated for.
        /// </summary>
