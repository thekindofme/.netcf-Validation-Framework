...
namespace ValidationFramework
{
    ...
    /// </summary>
    /// <example>
	/// <code source="Examples\ExampleLibraryCSharp\ParameterValidationManagerExamples\BasicHandleExample.cs" title="This example shows how to validate the parameters of a method using a RuntimeTypeHandle." lang="cs" region="Example"/>
	/// <code source="Examples\ExampleLibraryVB\ParameterValidationManagerExamples\BasicHandleExample.vb" title="This example shows how to validate the parameters of a method using a RuntimeTypeHandle." lang="vbnet" region="Example"/>
	...
	/// <code source="Examples\ExampleLibraryCSharp\ParameterValidationManagerExamples\ExplicitHandleExample.cs" title="This example shows how to validate the parameters of a that is an explicit implementation of an interface using a RuntimeTypeHandle." lang="cs" region="Example"/>
    /// <code source="Examples\ExampleLibraryVB\ParameterValidationManagerExamples\ExplicitHandleExample.vb" title="This example shows how to validate the parameters of a that is an explicit implementation of an interface using a RuntimeTypeHandle." lang="vbnet" region="Example"/>
	...
	/// <code source="Examples\ExampleLibraryCSharp\ParameterValidationManagerExamples\InheritedFromInterfaceHandleExample.cs" title="This example shows how to validate the parameters of a method by using attributes applied to an interface using a RuntimeTypeHandle." lang="cs" region="Example"/>
	/// <code source="Examples\ExampleLibraryVB\ParameterValidationManagerExamples\InheritedFromInterfaceHandleExample.vb" title="This example shows how to validate the parameters of a method by using attributes applied to an interface using a RuntimeTypeHandle." lang="vbnet" region="Example"/>
